...
- [系统架构图](https://z58362026.github.io/amazing/architecture/system-architecture.html) - 完整的系统架构设计
- [功能开发流程](https://z58362026.github.io/amazing/workflows/development.html) - 从需求到上线的完整流程
- [Bug 修复流程](https://z58362026.github.io/amazing/workflows/bug-fix.html) - Bug 修复和回滚机制
...
- [环境安装](./docs/getting-started/installation.md) - 安装配置指南
- [新手指南](./docs/getting-started/README.md) - 从这里开始

### 🏗️ 架构设计
- [架构总览](./docs/architecture/README.md) - 系统架构设计
- [AI 模式说明](./docs/architecture/ai-modes.md) - 全自动/半自动模式
- [模式切换指南](./docs/architecture/mode-switch.md) - 权限控制和切换流程

### 👥 角色指南
- [👑 架构师](./docs/roles/architect/README.md) - 技术决策和架构设计
- [📋 产品经理](./docs/roles/pm/README.md) - 需求管理和验收
- [🎨 前端开发](./docs/roles/frontend/README.md) - UI/UX 实现
- [⚙️ 后端开发](./docs/roles/backend/README.md) - API 和服务开发
- [所有角色](./docs/roles/README.md) - 查看所有角色文档

### 📖 使用指南
- [Claude Code 接入](./docs/guides/claude-code.md) - 主力开发工具
- [IronClaw 使用](./docs/guides/ironclaw.md) - Web 可视化界面
- [对话式角色申请](./docs/guides/role-chat.md) - 智能角色匹配
- [CLI 命令参考](./docs/reference/cli-commands.md) - 命令行工具
...
### 🚢 部署文档
- [部署指南](./docs/deployment/README.md) - 本地/Docker/K8s部署
